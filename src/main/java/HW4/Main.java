...
public class Main {
    public static void main(String[] args) {
        String[][] schedule1 = {{"Sunday", "Walking down the street"}, {"Monday", "Go to work"}};
        String[][] schedule2 = {{"Friday", "Do homework"}, {"Saturday", "Go to theatre"}};
...
//        --- FAMILY 1 ---
        ...
        Pet dog = new Pet("Dog", "Rex", 2, 45, new String[]{"walk", "eat", "sleep"});
        family2.setPet(dog);
